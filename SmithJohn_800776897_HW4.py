...
# Question 1 Q4: Due to the use of a non-linear kernal, the precision and accuracy are much
...
# Problem 2 Q2: Due to the SVC taking into account the weight for each feature, 
# these results are more accurate than those in Homework1

# Problem 2 Q3: I believe in this dataset, linear is better with peaks at 11.

# Problem 2 Q4: Plotting the different kernals, linear seems to have the best fit 
# with poly giving very similar results. 
